# Etymology Table Comparison

Side-by-side comparison of etymology tables for Dante's Divine Comedy showing word origins from multiple models:

- **gemini1-it**: Gemini 1.0 Pro Italian etymology tables
- **gemma3-it**: Gemma 3 27B Italian etymology tables
- **gptoss-it**: GPT-OSS 120B Italian etymology tables

Each comparison shows the original Italian line followed by etymology tables from all three models, enabling direct comparison of derived languages (Latin, Greek, Germanic) and etymological roots.
